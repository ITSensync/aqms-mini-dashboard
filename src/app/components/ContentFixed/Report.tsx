...
export default function Report() {
  ...
  return (
    <div className="p-6 w-full">
      <div className={` bg-blue-light/20 p-2 rounded-box opacity-85 mb-4`}>
        <p className="font-sf-pro-rounded text-xl font-bold text-blue-darkest text-center">
          Report Parameter Kualitas Udara
        </p>
      </div>
      <div
        className={`overflow-x-auto rounded-box border border-base-content/5 opacity-85 bg-blue-light/20`}
      >
        <table className="table text-blue-darkest font-sf-pro-rounded">
          {/* head */}
          <thead className="text-blue-darkest font-light text-center">
            <tr>
              <th></th>
              <th>Waktu</th>
            ...
            <tr>
              <td colSpan={getColSpan()} className="p-4">
                <div className="flex justify-end gap-3 px-2">
                  {page !== 1 && (
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="size-6 text-blue-darkest"
                      >
                        <path
                          fillRule="evenodd"
                  ...
                  <p className="text-blue-darkest font-sf-pro-rounded font-semibold text-md">
